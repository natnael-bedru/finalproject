...
const Landreg = (props: Props) => {
  ...
  const imageFieldReference = document.getElementById('file-upload') as HTMLInputElement;
...
// Register Land Form Submit BEGINING 
  ...
  const onSubmit = (data: any) => {
   ...
   data.currentWoreda = dropdownWoreda.current ? dropdownWoreda.current.value : 0;
   data.formerKebele = dropdownKebele.current ? dropdownKebele.current.value : 0;
                    ...
                    <div className="w-full  h-full flex flex-col justify-center items-center px-2 space-y-4">
                      ...
                      <div className="flex w-full space-x-4">
                        <div className="w-full">
                          ...
                          <Field required as="select"  name="typeOfHolding" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-white dark:text-black dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            <option value="" disabled selected>
                              Unspecified
                            </option>
                            <option value={'Permits hold'}>Permits hold</option>
                        ...
                        <div className="w-full">
                          ...
                          <Field required as="select" name="plannedLandUse" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-white dark:text-black dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            <option value="" disabled selected>
                              Unspecified
                            </option>
                        ...
                        <div className="w-full">
                          ...
                          <Field required as="select" name="permittedUse" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-white dark:text-black dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            <option value="" disabled selected>
                              Unspecified
                            </option>
                            <option value={'Mixed'}>Mixed</option>

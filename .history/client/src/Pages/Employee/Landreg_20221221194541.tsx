              ...
              <section className="p-3 rounded-md shadow-md  text-black">
                ...
                <form>
                  <div className="flex justify-between my-4  ">
                    <div className="h-auto flex flex-col    px-2">
                      {" "}
                      <div className="">
                    ...
                    <div className="w-full  h-full flex flex-col justify-center items-center px-2 space-y-4">
                      ...
                      <div>
                          ...
                          <div className="mt-1 flex justify-center items-center px-6 pt-5 pb-6 border-2 h-[400px] w-[400px] border-gray-300 border-dashed rounded-md">
                            <div className="space-y-1 text-center">
                              <svg
                                className="mx-auto h-12 w-12"
                                stroke="currentColor"

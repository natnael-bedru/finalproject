          ...
          <div className="mt-10 mx-auto flex flex-col w-full jsu">
            <div className="grid grid-cols-3 divide-x">
              ...
              <div>
                ...
                <p className=" dark:text-black">Full Name: {currCitizen.fullName}</p>
                ...
                <p className=" dark:text-black">Former Kebele:{currCitizen.kebeleNumber}</p>
                <p className=" dark:text-black">Current Woreda:{currCitizen.woredaNumber}</p>
                <p className=" dark:text-black">Subcity:{currCitizen.subCityName}</p>
              </div>
            </div>
